...
public class my_singleton {
    ...
    private static com.kierasis.attendancemonitoring.my_singleton mInstance;
    ...
    public static synchronized com.kierasis.attendancemonitoring.my_singleton getInstance(Context context){
        if(mInstance == null){
            mInstance = new com.kierasis.attendancemonitoring.my_singleton(context);
        }
        return mInstance;
    }
